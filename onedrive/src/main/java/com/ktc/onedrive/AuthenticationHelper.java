...
public class AuthenticationHelper {
    ...
    public void acquireTokenSilently(AuthenticationCallback callback,IAccount iAccount){
        mPCA.acquireTokenSilentAsync(mScopes, iAccount, callback);
    }
    ...
    public List<IAccount> getAccounts(){
        ...
        accounts.clear();
        if (!mPCA.getAccounts().isEmpty()){
            accounts.addAll(mPCA.getAccounts());
        }
        return accounts;
